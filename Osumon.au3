...
MsgBox (1,"Osumon","- Ctrl+Alt+O to change your keys (use Keys.txt)"&@CRLF&"- Ctrl+Q to quit"&@CRLF&"- Alt+P to see your Pokémon"&@crlf&"- Alt+A to catch the selected Pokémon")
